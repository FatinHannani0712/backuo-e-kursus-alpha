...
<head>
  ...
  <style>
    ...
    .hubungi-content h4:first-child {
      margin-top: 0;
    }
    .hubungi-map {
      border-radius: 8px;
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">
      <img src="assets/img/logo_apm.jpeg" width="50" height="50" class="d-inline-block align-text-top me-2">
      e-Kursus ALPHA
    </a>
    <div class="d-flex align-items-center">
      ...
      <a href="login.php" class="nav-action-btn login-btn">
        <a href="login.php" class="nav-action-btn login-btn"></a>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <div class="carousel-caption d-none d-md-block">
        <h1 class="text-white fw-bold">e-Kursus APM</h1>
        <p class="text-white">Platform atas talian untuk permohonon kursus -kursus latihan Angkatan Pertahanan Awam Di Akademi Latihan Pertahanan Awam (ALPHA) </p>
        <a href="register.php" class="btn btn-info text-dark btn-kursus shadow">
    ...
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-none d-md-block">
        ...
        <p class="text-white">Program latihan terkini untuk memenuhi keperluan pertahanan awam</p>
        <a href="register.php" class="btn btn-warning text-dark btn-kursus shadow">
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="info-card">
        ...
        <p>Menyediakan program latihan/kursus dalam bidang pertahanan awam bagi meningkatkan kefahaman, kecekapan dan kemahiran personel angkatan dan masyarakat yang berdaya tahan terhadap bencana.</p>
      </div>
      <div class="info-card">
        <h4 class="section-title"><i class="fas fa-eye me-2"></i>VISI</h4>
        <p>Menjadikan sebuah institusi latihan pertahanan awam yang mantap dan tetap unggul dalam menyediakan anggota angkatan dan masyarakat yang berdaya tahan terhadap bencana.</p>
      </div>
    </div>
    <div class="col-md-6">
      <div class="info-card">
        <h4 class="section-title"><i class="fas fa-rocket me-2"></i>MISI</h4>
        <p>Ke arah institusi kecemerlangan ilmu pertahanan awam di peringkat lokal dan antarabangsa.</p>
      </div>
      <div class="info-card">
        <h4 class="section-title"><i class="fas fa-quote-left me-2"></i>MOTTO</h4>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="hubungi-content">
          ...
          <p>
            <i class="fas fa-link contact-icon"></i> <a href="https://www.civildefence.gov.my/utama" target="_blank" class="text-decoration-none">civildefence.gov.my/alpha</a>
          </p>
          
          <h4><i class="fas fa-clock me-2"></i>Waktu Operasi:</h4>
          <p><i class="fas fa-door-open contact-icon"></i> Masa Rehat (1.00 - 2.00 tengah hari)</p>
        </div>
      </div>
      ...
      <div class="col-md-6">
        ...
        <div class="hubungi-content">
          ...
          <div class="social-media-links">
            <a href="https://www.instagram.com/alpha_bangi?igshid=YmMyMTA2M2Y=" target="_blank" class="btn btn-outline-primary mb-2 me-2">
              <i class="fab fa-instagram me-2"></i>Instagram
            </a>
            <a href="https://twitter.com/JPAM_ALPHA?t=Q3aStyQjvhkmfdOXLSVpIA&s=09" target="_blank" class="btn btn-outline-info mb-2 me-2">
              <i class="fab fa-twitter me-2"></i>Twitter
            </a>
            <a href="https://m.youtube.com/channel/UCXz37Po1IxdxnthcTg17Pag?noapp=1" target="_blank" class="btn btn-outline-danger mb-2">
...
<!-- FOOTER -->
<footer>
  <p>&copy; <?php echo date("Y"); ?> e-Kursus APM | Hak Cipta Terpelihara</p>
</footer>
