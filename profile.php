...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Auto-fill date if pengakuan is checked but don't override if already set
  ...
  <div class="profile-card">
    ...
    <div class="profile-body">
      ...
      <ul class="nav nav-tabs mb-4" id="profileTabs" role="tablist">
        ...
        <li class="nav-item" role="presentation">
          <button class="nav-link <?= isset($errors['no_tel_rumah']) || isset($errors['no_tel_pejabat']) ? 'tab-error' : '' ?>" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab">
            ...
            <div class="form-section">
              ...
              <div class="mb-3">
                ...
                <div class="input-group">
                  ...
                  <textarea class="form-control" id="alamat" name="alamat" rows="3" maxlength="255"><?= htmlspecialchars($userData['alamat'] ?? ''); ?></textarea>
                </div>
              </div>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (errorFields.length > 0) {
      ...
      } else if (firstError.id.includes('no_tel_rumah') || firstError.id.includes('no_tel_pejabat') || firstError.closest('#contact')) {
