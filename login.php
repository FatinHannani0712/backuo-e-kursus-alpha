...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true) {
    ...
    switch ($_SESSION['role']) {
        ...
        case 'user':
            ...
            break;
        default:
            header('Location: logout.php'); // unknown role → logout
            break;
    }
    exit;
}
                ...
                if (password_verify($password, $user['password'])) {
                    ...
                    switch ($user['role']) {
                        ...
                        case 'user':
                            ...
                            break;
                        default:
                            header('Location: logout.php'); // unknown role
                            break;
                    }
                    exit;
                } else {
...
<body>
  ...
  // Auto-format No KP (only numbers allowed)
  document.getElementById('no_kp').addEventListener('input', function() {
    this.value = this.value.replace(/\D/g, ''); // remove all non-numeric chars
  });
</script>
